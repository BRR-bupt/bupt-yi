...
export class VideoAsset extends Asset implements IVideoAsset {
  ...
  //   this.waveCanvass = this.waveContainer.querySelectorAll('canvas') as NodeListOf<HTMLCanvasElement>

  //   if (this.waveCanvass.length < 2) window.requestAnimationFrame(() => this.watch())
  // }
